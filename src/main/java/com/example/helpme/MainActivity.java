...
public class MainActivity extends BaseActivity {
        ...
        FirebaseDatabase.getInstance().getReference().child("user-posts")
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(String key : dataMap.keySet()){
                    ...
                    HashMap<String, String> data = dataMap.get(key);
                    ...
                    if(users.contains(post.author)){
                        ...
                        posts.add("user: " + post.author + " lat: " + post.lat
                                + " lng: " + post.lng + "time: " + post.time);
                    }
    ...
    private void submitPost() {
        ...
        final String lat = String.format(Locale.ENGLISH, "%f", mCurrentLocation.getLatitude());
        final String lng = String.format(Locale.ENGLISH, "%f", mCurrentLocation.getLongitude());
        final String time = String.format(Locale.ENGLISH, "%s", mLastUpdateTime);
            ...
            new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (user == null) {
                        ...
                        writeNewPost(userId, user.username, lat, lng, time);
                    }
                }
    ...
    // [START write_fan_out]
    private void writeNewPost(String userId, String username, String lat, String lng, String time) {
        // Create new post at /user-posts/$userid/$postid and at
        // /posts/$postid simultaneously
        String key = mDatabase.child("posts").push().getKey();
        Post post = new Post(userId, username, lat, lng, time);
